...
function showOrder(){
	...
	if((prod[0] == null)&&(prod[1] == null)&&(prod[2] == null)&&(prod[3] == null)&&(prod[4] == null)&&(prod[5] == null)&&(prod[6] == null)&&(prod[7] == null)&&(prod[8] == null)&&(prod[9] == null)&&(prod[10] == null))
		{
	...
	for(i=0;i<=prod.length;i++)
		...
		if((prod[i] != null)&&(prod[i] != ""))
			...
			document.write("$"+subTot.toFixed(2)+"</td><td>");
			document.write("<a class='small' href=# onclick = 'delProd("+[i]+")'>Remove Item</a>");
